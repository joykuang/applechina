...
},{"./className/add":6}],6:[function(require,module,exports){
/**
 * @copyright 2015 Apple Inc. All rights reserved.
 */
'use strict';
...
},{"./className/remove":9}],11:[function(require,module,exports){
/**
 * @module ac-headjs
 * @copyright 2015 Apple Inc. All rights reserved.
 */
...
var addClass = require('ac-classlist/add');
var removeClass = require('ac-classlist/remove');
var extend = require('ac-object/extend');
...
},{"ac-classlist/add":5,"ac-classlist/remove":10,"ac-object/extend":59}],12:[function(require,module,exports){
/**
 * @module ac-headjs
 * @copyright 2015 Apple Inc. All rights reserved.
 */
...
var touchAvailable = require('ac-feature/touchAvailable');
var svgAvailable = require('ac-feature/svgAvailable');

var oldieTest = function () {
	return (ac_browser.IE && ac_browser.IE.documentMode < 9);
};
...
},{"ac-browser":1,"ac-feature/svgAvailable":16,"ac-feature/touchAvailable":17}],13:[function(require,module,exports){
/**
 * @module ac-headjs
 * @copyright 2015 Apple Inc. All rights reserved.
 */
...
var ac_polyfills = require('ac-polyfills');
ac_polyfills.all.polyfill();
...
},{"./FeatureDetect":11,"./defaultTests":12,"ac-polyfills":18}],14:[function(require,module,exports){
/**
 * @copyright 2015 Apple Inc. All rights reserved.
 */
'use strict';
...
},{"./helpers/globals":14,"ac-function/once":15}],17:[function(require,module,exports){
/**
 * @copyright 2015 Apple Inc. All rights reserved.
 */
'use strict';
...
},{"./helpers/globals":14,"ac-function/once":15}],18:[function(require,module,exports){
module.exports["Array.isArray"] = require("./ac-polyfills/Array/isArray");
module.exports["Array.prototype.every"] = require("./ac-polyfills/Array/prototype.every");
module.exports["Array.prototype.filter"] = require("./ac-polyfills/Array/prototype.filter");
module.exports["Array.prototype.forEach"] = require("./ac-polyfills/Array/prototype.forEach");
module.exports["Array.prototype.indexOf"] = require("./ac-polyfills/Array/prototype.indexOf");
module.exports["Array.prototype.lastIndexOf"] = require("./ac-polyfills/Array/prototype.lastIndexOf");
module.exports["Array.prototype.map"] = require("./ac-polyfills/Array/prototype.map");
module.exports["Array.prototype.reduce"] = require("./ac-polyfills/Array/prototype.reduce");
module.exports["Array.prototype.reduceRight"] = require("./ac-polyfills/Array/prototype.reduceRight");
module.exports["Array.prototype.slice"] = require("./ac-polyfills/Array/prototype.slice");
module.exports["Array.prototype.some"] = require("./ac-polyfills/Array/prototype.some");
module.exports["CustomEvent"] = require("./ac-polyfills/CustomEvent");
module.exports["Date.now"] = require("./ac-polyfills/Date/now");
module.exports["Date.prototype.toISOString"] = require("./ac-polyfills/Date/prototype.toISOString");
module.exports["Date.prototype.toJSON"] = require("./ac-polyfills/Date/prototype.toJSON");
module.exports["Element-HTMLElement.prototype.classList"] = require("./ac-polyfills/Element-HTMLElement/prototype.classList");
module.exports["Function.prototype.bind"] = require("./ac-polyfills/Function/prototype.bind");
module.exports["JSON"] = require("./ac-polyfills/JSON");
module.exports["Object.assign"] = require("./ac-polyfills/Object/assign");
module.exports["Object.create"] = require("./ac-polyfills/Object/create");
module.exports["Object.is"] = require("./ac-polyfills/Object/is");
module.exports["Object.keys"] = require("./ac-polyfills/Object/keys");
module.exports["Promise"] = require("./ac-polyfills/Promise");
module.exports["String.prototype.trim"] = require("./ac-polyfills/String/prototype.trim");
module.exports["XMLHttpRequest"] = require("./ac-polyfills/XMLHttpRequest");
module.exports["console.log"] = require("./ac-polyfills/console.log");
module.exports["getComputedStyle"] = require("./ac-polyfills/getComputedStyle");
module.exports["html5shiv"] = require("./ac-polyfills/html5shiv");
module.exports["matchMedia"] = require("./ac-polyfills/matchMedia");
module.exports["requestAnimationFrame"] = require("./ac-polyfills/requestAnimationFrame");
module.exports.all = {
    polyfill: function() {
        require("./ac-polyfills/Array/isArray").polyfill();
        require("./ac-polyfills/Array/prototype.every").polyfill();
        require("./ac-polyfills/Array/prototype.filter").polyfill();
        require("./ac-polyfills/Array/prototype.forEach").polyfill();
        require("./ac-polyfills/Array/prototype.indexOf").polyfill();
        require("./ac-polyfills/Array/prototype.lastIndexOf").polyfill();
        require("./ac-polyfills/Array/prototype.map").polyfill();
        require("./ac-polyfills/Array/prototype.reduce").polyfill();
        require("./ac-polyfills/Array/prototype.reduceRight").polyfill();
        require("./ac-polyfills/Array/prototype.slice").polyfill();
        require("./ac-polyfills/Array/prototype.some").polyfill();
        require("./ac-polyfills/CustomEvent").polyfill();
        require("./ac-polyfills/Date/now").polyfill();
        require("./ac-polyfills/Date/prototype.toISOString").polyfill();
        require("./ac-polyfills/Date/prototype.toJSON").polyfill();
        require("./ac-polyfills/Element-HTMLElement/prototype.classList").polyfill();
        require("./ac-polyfills/Function/prototype.bind").polyfill();
        require("./ac-polyfills/JSON").polyfill();
        require("./ac-polyfills/Object/assign").polyfill();
        require("./ac-polyfills/Object/create").polyfill();
        require("./ac-polyfills/Object/is").polyfill();
        require("./ac-polyfills/Object/keys").polyfill();
        require("./ac-polyfills/Promise").polyfill();
        require("./ac-polyfills/String/prototype.trim").polyfill();
        require("./ac-polyfills/XMLHttpRequest").polyfill();
        require("./ac-polyfills/console.log").polyfill();
        require("./ac-polyfills/getComputedStyle").polyfill();
        require("./ac-polyfills/html5shiv").polyfill();
        require("./ac-polyfills/matchMedia").polyfill();
        require("./ac-polyfills/requestAnimationFrame").polyfill();
    }
};

},{"./ac-polyfills/Array/isArray":19,"./ac-polyfills/Array/prototype.every":20,"./ac-polyfills/Array/prototype.filter":21,"./ac-polyfills/Array/prototype.forEach":22,"./ac-polyfills/Array/prototype.indexOf":23,"./ac-polyfills/Array/prototype.lastIndexOf":24,"./ac-polyfills/Array/prototype.map":25,"./ac-polyfills/Array/prototype.reduce":26,"./ac-polyfills/Array/prototype.reduceRight":27,"./ac-polyfills/Array/prototype.slice":28,"./ac-polyfills/Array/prototype.some":29,"./ac-polyfills/CustomEvent":30,"./ac-polyfills/Date/now":31,"./ac-polyfills/Date/prototype.toISOString":32,"./ac-polyfills/Date/prototype.toJSON":33,"./ac-polyfills/Element-HTMLElement/prototype.classList":34,"./ac-polyfills/Function/prototype.bind":35,"./ac-polyfills/JSON":36,"./ac-polyfills/Object/assign":37,"./ac-polyfills/Object/create":38,"./ac-polyfills/Object/is":39,"./ac-polyfills/Object/keys":40,"./ac-polyfills/Promise":41,"./ac-polyfills/String/prototype.trim":42,"./ac-polyfills/XMLHttpRequest":43,"./ac-polyfills/console.log":44,"./ac-polyfills/getComputedStyle":45,"./ac-polyfills/html5shiv":46,"./ac-polyfills/matchMedia":47,"./ac-polyfills/requestAnimationFrame":48}],19:[function(require,module,exports){
module.exports = {
    polyfill: function() {
        if (!Array.isArray) {
            /**
...
module.exports = {
    polyfill: function() { // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is
        if (!Object.is) {
...
},{"es6-promise":49}],42:[function(require,module,exports){
module.exports = {
    polyfill: function() {
...
module.exports = {
    polyfill: function() { // https://raw.githubusercontent.com/jonathantneal/polyfill/master/source/Window.prototype.getComputedStyle.ie8.js
...
module.exports = {
    polyfill: function() { /* istanbul ignore next */
        /*@ignore*/
        /**
...
var ac_headjs = require('ac-headjs');
var ac_browser = require('ac-browser');
