...
}return h.parentNode.insertBefore(g,h.nextSibling)}},{"./internal/validate":28}],24:[function(c,d,a){var f=c("./internal/validate");
d.exports=function b(g,h){f.insertNode(g,true,"insertBefore");f.childNode(h,true,"insertBefore");
f.hasParentNode(h,"insertBefore");return h.parentNode.insertBefore(g,h)}},{"./internal/validate":28}],25:[function(c,d,b){var f=c("./internal/validate");
...
}},{"./internal/validate":28}],26:[function(b,c,a){var d=b("./internal/validate");
c.exports=function f(g,h){d.insertNode(g,true,"insertLastChild");d.parentNode(h,true,"insertLastChild");
return h.appendChild(g)}},{"./internal/validate":28}],27:[function(b,c,a){var d=b("../isNode");
c.exports=function f(h,g){if(!d(h)){return false}if(typeof g==="number"){return(h.nodeType===g)
}return(g.indexOf(h.nodeType)!==-1)}},{"../isNode":34}],28:[function(g,d,j){var b=g("./isNodeType");
...
if(!q.parentNode){throw new TypeError(t+": "+r+a)}}}},{"../COMMENT_NODE":14,"../DOCUMENT_FRAGMENT_NODE":15,"../ELEMENT_NODE":18,"../TEXT_NODE":19,"./isNodeType":27}],29:[function(c,d,a){var g=c("./internal/isNodeType");
var f=c("./COMMENT_NODE");d.exports=function b(h){return g(h,f)}},{"./COMMENT_NODE":14,"./internal/isNodeType":27}],30:[function(c,d,b){var g=c("./internal/isNodeType");
var a=c("./DOCUMENT_NODE");d.exports=function f(h){return g(h,a)}},{"./DOCUMENT_NODE":16,"./internal/isNodeType":27}],31:[function(c,d,b){var g=c("./internal/isNodeType");
var a=c("./DOCUMENT_FRAGMENT_NODE");d.exports=function f(h){return g(h,a)}},{"./DOCUMENT_FRAGMENT_NODE":15,"./internal/isNodeType":27}],32:[function(b,c,a){var g=b("./internal/isNodeType");
var f=b("./DOCUMENT_TYPE_NODE");c.exports=function d(h){return g(h,f)}},{"./DOCUMENT_TYPE_NODE":17,"./internal/isNodeType":27}],33:[function(c,d,b){var g=c("./internal/isNodeType");
var a=c("./ELEMENT_NODE");d.exports=function f(h){return g(h,a)}},{"./ELEMENT_NODE":18,"./internal/isNodeType":27}],34:[function(b,c,a){c.exports=function d(f){return !!(f&&f.nodeType)
}},{}],35:[function(c,d,b){var f=/^\[object (HTMLCollection|NodeList|Object)\]$/;
...
}},{}],36:[function(c,d,a){var g=c("./internal/isNodeType");var b=c("./TEXT_NODE");
d.exports=function f(h){return g(h,b)}},{"./TEXT_NODE":19,"./internal/isNodeType":27}],37:[function(c,d,b){var f=c("./internal/validate");
d.exports=function a(g){f.childNode(g,true,"remove");if(!g.parentNode){return g
}return g.parentNode.removeChild(g)}},{"./internal/validate":28}],38:[function(b,d,a){var f=b("./internal/validate");
...
}},{"./internal/validate":28}],39:[function(c,f,b){var g=c("ac-dom-nodes/isElement");
...
}if(k===document.body){break}}}return null}},{"./internal/validate":46,"./matchesSelector":48,"ac-dom-nodes/isElement":33}],40:[function(c,d,b){var g=c("ac-dom-nodes/isElement");
...
}}}return k}},{"./internal/validate":46,"./matchesSelector":48,"ac-dom-nodes/isElement":33}],41:[function(d,g,c){var b=d("ac-dom-nodes/filterByNodeType");
...
j=b(j);if(i){j=a(j,i)}return j}},{"./filterBySelector":42,"./internal/validate":46,"ac-dom-nodes/filterByNodeType":21}],42:[function(d,f,c){var b=d("./matchesSelector");
var g=d("./internal/validate");f.exports=function a(i,h){g.selector(h,true,"filterBySelector");
i=Array.prototype.slice.call(i);return i.filter(function(j){return b(j,h)})}},{"./internal/validate":46,"./matchesSelector":48}],43:[function(b,d,a){var c=b("./children");
...
}i=c(j,h);if(i.length){return i[0]}return null}},{"./children":41,"./internal/validate":46}],44:[function(b,c,a){c.exports={ancestor:b("./ancestor"),ancestors:b("./ancestors"),children:b("./children"),filterBySelector:b("./filterBySelector"),firstChild:b("./firstChild"),lastChild:b("./lastChild"),matchesSelector:b("./matchesSelector"),nextSibling:b("./nextSibling"),nextSiblings:b("./nextSiblings"),previousSibling:b("./previousSibling"),previousSiblings:b("./previousSiblings"),querySelector:b("./querySelector"),querySelectorAll:b("./querySelectorAll"),siblings:b("./siblings")}
},{"./ancestor":39,"./ancestors":40,"./children":41,"./filterBySelector":42,"./firstChild":43,"./lastChild":47,"./matchesSelector":48,"./nextSibling":49,"./nextSiblings":50,"./previousSibling":51,"./previousSiblings":52,"./querySelector":53,"./querySelectorAll":54,"./siblings":58}],45:[function(b,c,a){c.exports=window.Element?(function(d){return d.matches||d.matchesSelector||d.webkitMatchesSelector||d.mozMatchesSelector||d.msMatchesSelector||d.oMatchesSelector
}(Element.prototype)):null},{}],46:[function(g,c,i){var o=g("ac-dom-nodes/isNode");
var b=g("ac-dom-nodes/COMMENT_NODE");var k=g("ac-dom-nodes/DOCUMENT_FRAGMENT_NODE");
...
}}}},{"ac-dom-nodes/COMMENT_NODE":14,"ac-dom-nodes/DOCUMENT_FRAGMENT_NODE":15,"ac-dom-nodes/DOCUMENT_NODE":16,"ac-dom-nodes/ELEMENT_NODE":18,"ac-dom-nodes/TEXT_NODE":19,"ac-dom-nodes/isNode":34}],47:[function(b,d,a){var c=b("./children");
...
}i=c(j,h);if(i.length){return i[i.length-1]}return null}},{"./children":41,"./internal/validate":46}],48:[function(d,f,c){var g=d("ac-dom-nodes/isElement");
...
}if(!a){return h(k,j)}return a.call(k,j)}},{"./internal/nativeMatches":45,"./internal/validate":46,"./shims/matchesSelector":55,"ac-dom-nodes/isElement":33}],49:[function(c,d,b){var f=c("ac-dom-nodes/isElement");
...
}while(j=j.nextSibling){if(f(j)){if(!i||a(j,i)){return j}}}return null}},{"./internal/validate":46,"./matchesSelector":48,"ac-dom-nodes/isElement":33}],50:[function(d,f,b){var g=d("ac-dom-nodes/isElement");
...
}}}return j}},{"./internal/validate":46,"./matchesSelector":48,"ac-dom-nodes/isElement":33}],51:[function(c,d,b){var g=c("ac-dom-nodes/isElement");
...
}while(j=j.previousSibling){if(g(j)){if(!i||a(j,i)){return j}}}return null}},{"./internal/validate":46,"./matchesSelector":48,"ac-dom-nodes/isElement":33}],52:[function(c,d,b){var f=c("ac-dom-nodes/isElement");
...
}}}return j.reverse()}},{"./internal/validate":46,"./matchesSelector":48,"ac-dom-nodes/isElement":33}],53:[function(c,d,a){var h=c("./internal/validate");
...
if(!g){return b(i,j)}return j.querySelector(i)}},{"./internal/validate":46,"./shims/querySelector":56}],54:[function(b,c,a){var h=b("./internal/validate");
var g=b("./shims/querySelectorAll");var f=("querySelectorAll" in document);c.exports=function d(i,j){j=j||document;
h.parentNode(j,true,"querySelectorAll","context");h.selector(i,true,"querySelectorAll");
if(!f){return g(i,j)}return Array.prototype.slice.call(j.querySelectorAll(i))}},{"./internal/validate":46,"./shims/querySelectorAll":57}],55:[function(c,d,b){var f=c("../querySelectorAll");
d.exports=function a(l,g){var k=l.parentNode||document;var h=f(g,k);var j;for(j=0;
j<h;j++){if(h[j]===l){return true}}return false}},{"../querySelectorAll":54}],56:[function(b,c,a){var d=b("./querySelectorAll");
c.exports=function f(h,i){var g=d(h,i);return g.length?g[0]:null}},{"./querySelectorAll":57}],57:[function(c,d,b){var h=c("ac-dom-nodes/isElement");
...
var m;document[i]=[];if(g(l)){l.appendChild(o)}else{document.body.appendChild(o)
...
break}}}k.push(m)}document[i]=null;a(o);return k}},{"ac-dom-nodes/isDocumentFragment":31,"ac-dom-nodes/isElement":33,"ac-dom-nodes/remove":37}],58:[function(b,d,a){var c=b("./children");
...
})}return i}},{"./children":41,"./internal/validate":46}],59:[function(b,c,a){c.exports.DOMEmitter=b("./ac-dom-emitter/DOMEmitter")
},{"./ac-dom-emitter/DOMEmitter":60}],60:[function(b,c,a){var g;var f=b("ac-event-emitter").EventEmitter;
...
this.off();this.el=this._eventEmitter=this._bindings=null};c.exports=h},{"ac-event-emitter":112}],61:[function(c,d,b){var a=c("./ac-dom-styles/vendorTransformHelper");
...
},{}],64:[function(b,c,a){var g=b("ac-dom-styles");var h={};var f=function(){return{x:window.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,y:window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop}
...
c.exports=h},{"./ac-dom-metrics/ie":65,"ac-dom-styles":61}],65:[function(b,c,a){c.exports=function(d){if(!("getBoundingClientRect" in document.createElement("_"))){d.getBoundingBox=function(h){var j=h.offsetLeft;
var i=h.offsetTop;var g=h.offsetWidth;var f=h.offsetHeight;return{top:i,right:j+g,bottom:i+f,left:j,width:g,height:f}
}}}},{}],66:[function(b,c,a){var d={querySelector:b("./ac-dom-traversal/querySelector"),querySelectorAll:b("./ac-dom-traversal/querySelectorAll"),ancestor:b("./ac-dom-traversal/ancestor"),ancestors:b("./ac-dom-traversal/ancestors"),children:b("./ac-dom-traversal/children"),firstChild:b("./ac-dom-traversal/firstChild"),lastChild:b("./ac-dom-traversal/lastChild"),siblings:b("./ac-dom-traversal/siblings"),nextSibling:b("./ac-dom-traversal/nextSibling"),nextSiblings:b("./ac-dom-traversal/nextSiblings"),previousSibling:b("./ac-dom-traversal/previousSibling"),previousSiblings:b("./ac-dom-traversal/previousSiblings"),filterBySelector:b("./ac-dom-traversal/filterBySelector"),matchesSelector:b("./ac-dom-traversal/matchesSelector")};
b("./ac-dom-traversal/shims/ie")(d);c.exports=d},{"./ac-dom-traversal/ancestor":67,"./ac-dom-traversal/ancestors":68,"./ac-dom-traversal/children":69,"./ac-dom-traversal/filterBySelector":70,"./ac-dom-traversal/firstChild":71,"./ac-dom-traversal/lastChild":74,"./ac-dom-traversal/matchesSelector":75,"./ac-dom-traversal/nextSibling":76,"./ac-dom-traversal/nextSiblings":77,"./ac-dom-traversal/previousSibling":78,"./ac-dom-traversal/previousSiblings":79,"./ac-dom-traversal/querySelector":80,"./ac-dom-traversal/querySelectorAll":81,"./ac-dom-traversal/shims/ie":82,"./ac-dom-traversal/siblings":83}],67:[function(d,g,c){var a=d("ac-dom-nodes");
...
}if(j===document.body){break}}}return null}},{"./helpers/validate":73,"./matchesSelector":75,"ac-dom-nodes":22}],68:[function(d,f,c){var a=d("ac-dom-nodes");
...
}if(k===document.body){break}}}return j}},{"./helpers/validate":73,"./matchesSelector":75,"ac-dom-nodes":22}],69:[function(d,g,c){var a=d("ac-dom-nodes");
var b=d("./filterBySelector");var h=d("./helpers/validate");g.exports=function f(k,i){var j;
h.parentNode(k,true,"children");h.selector(i,false,"children");j=k.children||k.childNodes;
j=a.filterByNodeType(j);if(i){j=b(j,i)}return j}},{"./filterBySelector":70,"./helpers/validate":73,"ac-dom-nodes":22}],70:[function(d,f,c){var b=d("./matchesSelector");
var g=d("./helpers/validate");f.exports=function a(i,h){g.selector(h,true,"filterBySelector");
i=Array.prototype.slice.call(i);return i.filter(function(j){return b(j,h)})}},{"./helpers/validate":73,"./matchesSelector":75}],71:[function(b,d,a){var c=b("./children");
var g=b("./helpers/validate");d.exports=function f(j,h){var i;g.parentNode(j,true,"firstChild");
g.selector(h,false,"firstChild");if(j.firstElementChild&&!h){return j.firstElementChild
}i=c(j,h);if(i.length){return i[0]}return null}},{"./children":69,"./helpers/validate":73}],72:[function(b,c,a){c.exports=window.Element?(function(d){return d.matches||d.matchesSelector||d.webkitMatchesSelector||d.mozMatchesSelector||d.msMatchesSelector||d.oMatchesSelector
}(Element.prototype)):null},{}],73:[function(d,b,f){var j=d("ac-dom-nodes");var a=function(m,l){if(!j.isNode(m)){return false
...
}}}},{"ac-dom-nodes":22}],74:[function(b,d,a){var c=b("./children");var g=b("./helpers/validate");
...
}return null}},{"./children":69,"./helpers/validate":73}],75:[function(f,g,d){var b=f("ac-dom-nodes");
var a=f("./helpers/nativeMatches");var h=f("./helpers/validate");g.exports=function c(j,i){h.selector(i,true,"matchesSelector");
return b.isElement(j)?a.call(j,i):false}},{"./helpers/nativeMatches":72,"./helpers/validate":73,"ac-dom-nodes":22}],76:[function(d,f,c){var a=d("ac-dom-nodes");
...
}},{"./helpers/validate":73,"./matchesSelector":75,"ac-dom-nodes":22}],77:[function(f,g,c){var a=f("ac-dom-nodes");
...
}}}return j}},{"./helpers/validate":73,"./matchesSelector":75,"ac-dom-nodes":22}],78:[function(d,f,c){var a=d("ac-dom-nodes");
...
}},{"./helpers/validate":73,"./matchesSelector":75,"ac-dom-nodes":22}],79:[function(d,f,c){var a=d("ac-dom-nodes");
var b=d("./matchesSelector");var h=d("./helpers/validate");f.exports=function g(k,i){var j=[];
...
}}}return j.reverse()}},{"./helpers/validate":73,"./matchesSelector":75,"ac-dom-nodes":22}],80:[function(b,c,a){var f=b("./helpers/validate");
c.exports=function d(g,h){h=h||document;f.parentNode(h,true,"querySelector","context");
f.selector(g,true,"querySelector");return h.querySelector(g)}},{"./helpers/validate":73}],81:[function(b,c,a){var f=b("./helpers/validate");
...
}},{"./helpers/validate":73}],82:[function(d,f,c){var g=d("../vendor/sizzle/sizzle");
...
}}}},{"../helpers/nativeMatches":72,"../helpers/validate":73,"../vendor/sizzle/sizzle":84,"ac-dom-nodes":22}],83:[function(b,d,a){var c=b("./children");
var g=b("./helpers/validate");d.exports=function f(j,h){var i=[];g.childNode(j,true,"siblings");
g.selector(h,false,"siblings");if(j.parentNode){i=c(j.parentNode,h);i=i.filter(function(k){return(k!==j)
})}return i}},{"./children":69,"./helpers/validate":73}],84:[function(b,c,a){
/*!
...
}else{ae.Sizzle=ad}})(window)},{}],85:[function(b,c,a){c.exports={DOMEmitter:b("./ac-dom-emitter/DOMEmitter")}
},{"./ac-dom-emitter/DOMEmitter":86}],86:[function(c,b,d){var f;var j=c("ac-event-emitter").EventEmitter,g=c("ac-dom-events"),a=c("ac-dom-traversal");
...
},{"ac-dom-events":13,"ac-dom-traversal":66,"ac-event-emitter":112}],87:[function(b,c,a){c.exports={SharedInstance:b("./ac-shared-instance/SharedInstance")}
},{"./ac-shared-instance/SharedInstance":88}],88:[function(d,h,c){var i=window,g="AC",a="SharedInstance",f=i[g];
...
}h.exports=f[a]},{}],89:[function(b,c,a){c.exports={WindowDelegate:b("./ac-window-delegate/WindowDelegate"),WindowDelegateOptimizer:b("./ac-window-delegate/WindowDelegateOptimizer"),WindowDelegateCustomEvent:b("./ac-window-delegate/WindowDelegateCustomEvent")}
},{"./ac-window-delegate/WindowDelegate":92,"./ac-window-delegate/WindowDelegateCustomEvent":93,"./ac-window-delegate/WindowDelegateOptimizer":94}],90:[function(b,c,a){var f=b("ac-event-emitter").EventEmitter;
...
},{"ac-event-emitter":112}],91:[function(b,c,a){var g=b("ac-event-emitter").EventEmitter;
...
};c.exports=d},{"ac-event-emitter":112}],92:[function(d,b,g){var i;var c=d("ac-shared-instance").SharedInstance,l=d("ac-dom-emitter").DOMEmitter,j=d("./OptimizerController"),f=d("./CustomEventController"),h=d("./queries/queries"),m=d("./optimizers/optimizers");
...
};b.exports=c.share(k,a,n)},{"./CustomEventController":90,"./OptimizerController":91,"./optimizers/optimizers":97,"./queries/queries":106,"ac-dom-emitter":85,"ac-shared-instance":87}],93:[function(c,d,a){var g=c("ac-event-emitter").EventEmitter;
...
}return this};d.exports=b},{"ac-event-emitter":112}],94:[function(c,d,b){var g=c("ac-event-emitter").EventEmitter;
...
this.trigger("deactivate",this)};d.exports=a},{"ac-event-emitter":112}],95:[function(f,g,b){var a=f("../../WindowDelegateOptimizer"),d=f("../../queries/queries");
...
}});g.exports=h},{"../../WindowDelegateOptimizer":94,"../../queries/queries":106}],96:[function(g,h,b){var a=g("../../WindowDelegateOptimizer"),f=g("../../queries/queries");
...
}});h.exports=c},{"../../WindowDelegateOptimizer":94,"../../queries/queries":106}],97:[function(d,f,b){var c=d("./events/resize"),a=d("./events/scroll");
f.exports=[c,a]},{"./events/resize":95,"./events/scroll":96}],98:[function(b,c,a){var d=function(f){return document.documentElement.clientHeight
};c.exports=d},{}],99:[function(b,c,a){var d=function(f){return document.documentElement.clientWidth
};c.exports=d},{}],100:[function(b,d,a){var c=function(f){return window.innerHeight||this.clientHeight(f)
};d.exports=c},{}],101:[function(b,c,a){var d=function(f){return window.innerWidth||this.clientWidth(f)
};c.exports=d},{}],102:[function(c,d,a){var b=function(f){return document.body.scrollWidth-this.innerWidth()
};d.exports=b},{}],103:[function(c,d,b){var a=function(f){return document.body.scrollHeight-this.innerHeight()
};d.exports=a},{}],104:[function(b,c,a){var d=function(f){var h=window.pageXOffset;
if(!h){var g=document.documentElement||document.body.parentNode||document.body;
h=g.scrollLeft}return h};c.exports=d},{}],105:[function(b,c,a){var d=function(f){var h=window.pageYOffset;
if(!h){var g=document.documentElement||document.body.parentNode||document.body;
h=g.scrollTop}return h};c.exports=d},{}],106:[function(i,g,k){var b=i("./methods/innerWidth"),j=i("./methods/innerHeight"),d=i("./methods/clientWidth"),l=i("./methods/clientHeight"),c=i("./methods/scrollX"),a=i("./methods/scrollY"),h=i("./methods/maxScrollX"),f=i("./methods/maxScrollY");
g.exports={innerWidth:b,innerHeight:j,clientWidth:d,clientHeight:l,scrollX:c,scrollY:a,maxScrollX:h,maxScrollY:f}
},{"./methods/clientHeight":98,"./methods/clientWidth":99,"./methods/innerHeight":100,"./methods/innerWidth":101,"./methods/maxScrollX":102,"./methods/maxScrollY":103,"./methods/scrollX":104,"./methods/scrollY":105}],107:[function(b,c,a){var d=b("./ac-element-tracker/ElementTracker");
c.exports=new d();c.exports.ElementTracker=d},{"./ac-element-tracker/ElementTracker":108}],108:[function(d,c,h){var i;
...
}return p};c.exports=b},{"./TrackedElement":109,"ac-array":1,"ac-dom-metrics":64,"ac-dom-nodes":22,"ac-event-emitter":112,"ac-object":118,"ac-window-delegate":89}],109:[function(d,f,c){var g;
...
}g=h.prototype=b.create(i.prototype);f.exports=h},{"ac-dom-emitter":59,"ac-dom-nodes":22,"ac-object":118}],110:[function(b,d,a){var c=b("./ac-element-engagement/ElementEngagement");
d.exports=new c();d.exports.ElementEngagement=c},{"./ac-element-engagement/ElementEngagement":111}],111:[function(c,b,f){var g;
...
},this)};b.exports=a},{"ac-element-tracker":107,"ac-object":118}],112:[function(b,c,a){c.exports.EventEmitter=b("./ac-event-emitter/EventEmitter")
},{"./ac-event-emitter/EventEmitter":113}],113:[function(d,c,f){var h="EventEmitter:propagation";
...
}}}return false};c.exports=k},{}],114:[function(c,f,b){var d={cssPropertyAvailable:c("./ac-feature/cssPropertyAvailable"),localStorageAvailable:c("./ac-feature/localStorageAvailable")};
...
};f.exports=d},{"./ac-feature/cssPropertyAvailable":115,"./ac-feature/localStorageAvailable":116}],115:[function(c,f,b){var g=null;
...
}}return false}}},{}],116:[function(d,f,b){var a=null;f.exports=function c(){if(a===null){a=!!(window.localStorage&&window.localStorage.non_existent!==null)
}return a}},{}],117:[function(i,c,y){var t=Object.prototype.toString;var l=Object.prototype.hasOwnProperty;
...
}catch(A){return B}}},{}],118:[function(b,c,a){c.exports={clone:b("./ac-object/clone"),create:b("./ac-object/create"),defaults:b("./ac-object/defaults"),extend:b("./ac-object/extend"),getPrototypeOf:b("./ac-object/getPrototypeOf"),isDate:b("./ac-object/isDate"),isEmpty:b("./ac-object/isEmpty"),isRegExp:b("./ac-object/isRegExp"),toQueryParameters:b("./ac-object/toQueryParameters")}
...
c.exports=function d(g){return f({},g)}},{"./extend":122}],120:[function(b,d,a){var f=function(){};
...
return new f()}}},{}],121:[function(b,c,a){var f=b("./extend");c.exports=function d(h,g){if(typeof h!=="object"){throw new TypeError("defaults: must provide a defaults object")
}g=g||{};if(typeof g!=="object"){throw new TypeError("defaults: options must be a typeof object")
}return f({},h,g)}},{"./extend":122}],122:[function(c,d,b){var a=Object.prototype.hasOwnProperty;
...
}}}});return g}},{}],123:[function(c,d,b){var a=Object.prototype.hasOwnProperty;
...
i.constructor=h}return g?g.prototype:null}}}}},{}],124:[function(b,d,a){d.exports=function c(f){return Object.prototype.toString.call(f)==="[object Date]"
}},{}],125:[function(c,d,b){var a=Object.prototype.hasOwnProperty;d.exports=function f(g){var h;
if(typeof g!=="object"){throw new TypeError("ac-base.Object.isEmpty : Invalid parameter - expected object")
}for(h in g){if(a.call(g,h)){return false}}return true}},{}],126:[function(c,d,b){d.exports=function a(f){return window.RegExp?f instanceof RegExp:false
}},{}],127:[function(c,f,b){var a=c("qs");f.exports=function d(g){if(typeof g!=="object"){throw new TypeError("toQueryParameters error: argument is not an object")
}return a.stringify(g)}},{qs:117}],128:[function(d,f,c){var a=d("./s-code/s-code");
var b=d("./s-code/plugins");f.exports.init=a;f.exports.plugins=b},{"./s-code/plugins":129,"./s-code/s-code":142}],129:[function(b,c,a){function d(f){b("./plugins/utilities/utilities")(f);
...
},{"./plugins/customLinkHandler":130,"./plugins/detectRIA":131,"./plugins/deviceOrientationChanges":132,"./plugins/downloadLinkHandler":133,"./plugins/getAndpersistValue":134,"./plugins/getPercentPageViewed":135,"./plugins/getPreviousValue":136,"./plugins/getQueryParam":137,"./plugins/getValOnce":138,"./plugins/setClickMapEmail":139,"./plugins/setDynamicObjectIDs":140,"./plugins/utilities/utilities":141}],130:[function(b,c,a){c.exports=function(d){d.linkHandler=new Function("p","t","var s=this,h=s.p_gh(),i,l;t=t?t:'o';if(!h||(s.linkType&&(h||s.linkName)))return '';i=h.indexOf('?');h=s.linkLeaveQueryString||i<0?h:h.substring(0,i);l=s.pt(p,'|','p_gn',h.toLowerCase());if(l){s.linkName=l=='[['?'':l;s.linkType=t;return h;}return '';");
...
}},{}],133:[function(b,c,a){c.exports=function(d){d.downloadLinkHandler=new Function("p","var s=this,h=s.p_gh(),n='linkDownloadFileTypes',i,t;if(!h||(s.linkType&&(h||s.linkName)))return '';i=h.indexOf('?');t=s[n];s[n]=p?p:t;if(s.lt(h)=='d')s.linkType='d';else h='';s[n]=t;return h;")
}},{}],134:[function(b,c,a){c.exports=function(d){d.getAndPersistValue=new Function("v","c","e","var s=this,a=new Date;e=e?e:0;a.setTime(a.getTime()+e*86400000);if(v)s.c_w(c,v,e?a:0);return s.c_r(c);");
...
}},{}],138:[function(b,c,a){c.exports=function(d){d.getValOnce=new Function("v","c","e","var s=this,a=new Date,v=v?v:v='',c=c?c:c='s_gvo',e=e?e:0,k=s.c_r(c);if(v){a.setTime(a.getTime()+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v")
...
}())},{}],143:[function(c,d,b){var a=c("./ac-s-code/sCode");d.exports={init:a.init,getInstance:a.getInstance}
},{"./ac-s-code/sCode":157}],144:[function(b,c,a){(function(){function d(h){var f="";
...
}c.exports=d})()},{}],145:[function(b,c,a){(function(){var i=b("../plugin/sCodePlugins");
...
o.dc=g.getDataCenterId()}c.exports=h})()},{"../plugin/sCodePlugins":156,"./../plugin/helper/dynamicObjectIdHandlerSafari":150,"./helper/browser":146,"./server":147}],146:[function(b,c,a){(function(){function f(){if(navigator&&navigator.loadPurpose&&navigator.loadPurpose==="preview"){return true
...
}}return false}c.exports={isSafariTopSitesPreview:f,isSafari:d}})()},{}],147:[function(b,c,a){(function(){var i=["www.apple.com","images.apple.com","movies.apple.com","ssl.apple.com"];
...
})()},{}],148:[function(b,c,a){(function(){function f(h){var g=h.u.match(/(iphone|ipod|ipad|android|kindle|silk-accelerated)/i);
...
}c.exports=f}())},{}],149:[function(b,c,a){(function(){function d(g){if(g.pageName){var f=escape(g.pageName);
f=f.replace(/(%u2018|%u2019|%u02BC|%u02BD)/g,"%27");f=f.replace(/(%u201C|%u201D|%E2%80%9C|%E2%80%9D)/g,"%22");
f=f.replace(/(%09|%0A|%0D)/g,"");g.pageName=unescape(f)}}c.exports=d}())},{}],150:[function(b,c,a){(function(){function d(f,g){if(f.lt(g.href)){g.addEventListener("mouseup",function(i){if(((i.which)&&(i.which===1))||((i.button)&&(i.button===1))){var j=i.currentTarget.href;
...
f.linkTrackEvents="None"}},false)}}c.exports=d}())},{}],151:[function(b,c,a){(function(){function d(g){var A=new Date();
...
return q+"="+1}}}}c.exports=d}())},{}],152:[function(b,c,a){(function(){function d(g){var h;
...
}())},{}],153:[function(b,c,a){(function(){function d(f){if(!f.prop17){var k=f.getPercentPageViewed(f.pageName);
...
},{}],154:[function(b,c,a){(function(){function d(l){if(((l.pageName&&l.prop14&&l.pageName.toLowerCase()!==l.prop14.toLowerCase())||!l.prop14)&&l.tcall){var f;
...
l.c_w("s_pathLength",k,o);l.prop48="1"}}}c.exports=d}())},{}],155:[function(b,c,a){(function(){function d(m){if(m.tcall){var k;
...
}())},{}],156:[function(b,c,a){(function(){var f=b("./helper/plpChannel");var d=b("./helper/cleanPageName");
var i=b("./helper/osDetect");var h=b("./helper/percentPageViewed");var j=b("./helper/QTCheck");
var l=b("./helper/setMembership");var g=b("./helper/getVisitNumPerChannel");function k(t){t.tcall=(typeof(t.linkType)==="undefined")?true:false;
if(typeof(d)==="function"){d(t)}var o="/(apple.com/retail/.+/map/|apple.com/buy/locator/|discussions.apple.com|discussionsjapan.apple.com)/g";
if(!t.d.URL.match(o)){t.setupDynamicObjectIDs()}if(navigator&&navigator.platform){if(window.devicePixelRatio>=1.5){t.prop5=navigator.platform+" 2x"
}else{t.prop5=navigator.platform}}var v=t.getQueryParam("ref");if(v&&t.tcall){t.referrer=v
}else{if(v&&!t.tcall){t.referrer=""}}if(!t.campaign){t.campaign=t.getQueryParam("cid");
t.setClickMapEmail("Email_PageName,Email_OID","Email_OT");if(t.campaign.match(/OAS-.+?-DOMAINS-/i)){var w="http://"+t.campaign.replace(/OAS-.+?-DOMAINS-/i,"");
t.referrer=(t.tcall)?w:""}}t.server=t.getQueryParam("alias");if(!t.server){t.server="new approach ac-analytics"
}t.campaign=t.getValOnce(t.campaign,"s_campaign",0);t.prop6=(!t.prop6&&t.getQueryParam("cp")&&t.pageName)?('D="'+t.getQueryParam("cp").toLowerCase()+": "+t.pageName+'"'):t.prop6;
t.prop11=t.getQueryParam("sr");if(!t.d.URL.match(/\/channel\//)&&!t.prop11&&t.c_r("s_3p")){t.prop11=t.c_r("s_3p");
t.c_w("s_3p","",-1)}t.eVar7=(!t.eVar7)?t.getQueryParam("aid"):"";t.eVar7=t.getValOnce(t.eVar7,"s_var_7",0);
if(t.eVar2){t.events=t.apl(t.events,"event6",", ",1)}if((!t.d.URL.match(/apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search\//)&&!t.d.URL.match(/apple.com\/search\//))&&(t.d.referrer.match(/apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search\//)||t.d.referrer.match(/apple.com\/search\//))){t.eVar2=(t.d.referrer.match(/\/support\//))?"acs: ":((t.d.referrer.match(/\/store\//)?"aos: ":"www: "));
if(t.d.referrer.match(/apple.com\/(\w{2}|befr|benl|chfr|chde|asia|lae)\/search/)){t.eVar2+=t.getQueryParam("q","",t.d.referrer).replace(/\+/g," ");
var r=t.d.referrer.match(/\/(\w{2}|befr|benl|chfr|chde|asia|lae)\//i);t.eVar2+=" ("+r[0].replace(/\//g,"")+")"
}else{t.eVar2+=t.getQueryParam("q","",t.d.referrer).replace(/\+/g," ")+" (us)"}}if(t.prop11==="em"&&t.tcall){t.referrer="imap://chatterbox.com"
}if(t.prop11==="app"&&t.tcall){t.referrer="file://fromApp"}if(document.referrer&&document.referrer.indexOf("apple.com/startpage/")>-1&&t.tcall){t.referrer="news://startpage.com";
t._1_referrer=1}if(typeof(h)==="function"){h(t)}t.prop38=(t.tcall)?t.deviceOrientationChanges(true):"";
t.prop32=t.eVar32=t.getQueryParam("psid");if(t.prop32||t.c_r("s_sid")){var x=new Date();
var u=x.getTime();x.setTime(u+630720000);if(t.prop32){t.c_w("s_psid",t.prop32,x)
}else{t.c_w("s_psid",t.c_r("s_sid"),x)}t.c_w("s_sid","",-1)}if(!t.prop32&&!t.c_r("s_pathLength")){t.prop32=t.c_r("s_psid")
}if(!t.prop20){var p=navigator.userAgent.match(/foh:r\d{3}/i);t.prop20=p?("store kiosk:"+p.toString().replace(/foh:/i,"")):"non-store kiosk"
}t.linkLeaveQueryString=true;var y=t.downloadLinkHandler();if(y){if(y.match(/\.rss|\.xml/)){t.eVar16=t.prop16="sign ups"
}else{t.eVar11=((t.pageName&&t.pageName!=="")?t.pageName:"")+" - "+y.substring(y.lastIndexOf("/")+1,y.length);
t.eVar16=t.prop16="downloads";t.events=t.apl(t.events,"event5",", ",1)}t.linkTrackVars="prop16,eVar16,eVar11,events";
t.linkTrackEvents="event5"}t.linkLeaveQueryString=false;if(typeof(j)==="function"&&t.tcall){t.prop18=j(t)
}if(typeof(i)==="function"){i(t)}if(t.pageName&&t.pageName.match(/feedback - thank you/)){t.prop16=t.eVar16="feedback"
}t.linkLeaveQueryString=true;var q=t.linkHandler("itms.apple.com|itunes.apple.com","e");
var n=t.linkHandler("ax.itunes.apple.com/WebObjects/MZStoreServices.woa/ws/RSS/|rss.support.apple.com","o");
if(n){t.eVar16=t.prop16="sign ups";t.linkTrackVars="eVar16,prop16"}t.linkLeaveQueryString=false;
if(typeof(l)==="function"){l(t)}if(typeof f==="function"){f(t)}if(t.tcall){t.prop50=g(s)
}t.hier1=(t.channel)?t.channel:"";t.linkTrackVars=t.apl(t.linkTrackVars,"hier1",", ",1);
t.linkTrackVars=t.linkTrackVars.replace(new RegExp(" ","g"),"");function m(){var A=(t&&t.c_r)?t.c_r("s_vi"):"";
var z=A.match(/^\s*\[CS\]v1\|(.+)\[CE\]\s*$/);if(z){return z[1]}}t.prop49="D="+(m()||"s_vi");
t.prop4=(t.prop4)?t.prop4:"D=g";t.manageVars("lowercaseVars","purchaseID,pageType,events,products,transactionID",2)
}c.exports=k})()},{"./helper/QTCheck":148,"./helper/cleanPageName":149,"./helper/getVisitNumPerChannel":151,"./helper/osDetect":152,"./helper/percentPageViewed":153,"./helper/plpChannel":154,"./helper/setMembership":155}],157:[function(b,c,a){(function(){var d=b("s-code");
var g=b("./config/account");var j=b("./config/defaults");var f;function i(l){if(!f){var m=(l.bucket||"");
f=window.s=d.init(g(m));var k=d.plugins.init(f);j(f,l)}return f}function h(){return f
}c.exports={init:i,getInstance:h}}())},{"./config/account":144,"./config/defaults":145,"s-code":128}],158:[function(b,c,a){c.exports={adler32:b("./ac-checksum/adler32")}
},{"./ac-checksum/adler32":159}],159:[function(b,c,a){c.exports=function d(h){var f=65521;
var k=1;var g=0;var l;var j;for(j=0;j<h.length;j+=1){l=h.charCodeAt(j);k=(k+l)%f;
g=(g+k)%f}return(g<<16)|k}},{}],160:[function(b,c,a){c.exports=b(114)},{"./ac-feature/cssPropertyAvailable":161,"./ac-feature/localStorageAvailable":162}],161:[function(b,c,a){c.exports=b(115)
},{}],162:[function(b,c,a){c.exports=b(116)},{}],163:[function(b,c,a){c.exports=b(117)
},{}],164:[function(b,c,a){c.exports=b(118)},{"./ac-object/clone":165,"./ac-object/create":166,"./ac-object/defaults":167,"./ac-object/extend":168,"./ac-object/getPrototypeOf":169,"./ac-object/isDate":170,"./ac-object/isEmpty":171,"./ac-object/isRegExp":172,"./ac-object/toQueryParameters":173}],165:[function(b,c,a){c.exports=b(119)
},{"./extend":168}],166:[function(b,c,a){c.exports=b(120)},{}],167:[function(b,c,a){c.exports=b(121)
},{"./extend":168}],168:[function(b,c,a){c.exports=b(122)},{}],169:[function(b,c,a){c.exports=b(123)
},{}],170:[function(b,c,a){c.exports=b(124)},{}],171:[function(b,c,a){c.exports=b(125)
},{}],172:[function(b,c,a){c.exports=b(126)},{}],173:[function(b,c,a){c.exports=b(127)
},{qs:163}],174:[function(d,g,a){var h="ac-storage-";var c=d("./ac-storage/Item");
var i=d("./ac-storage/Storage");var b=d("./ac-storage/Storage/storageAvailable");
var f=new i(h);f.Item=c;f.storageAvailable=b;g.exports=f},{"./ac-storage/Item":175,"./ac-storage/Storage":182,"./ac-storage/Storage/storageAvailable":184}],175:[function(d,b,j){var a=d("ac-checksum").adler32;
...
}};f.createExpirationDate=c;b.exports=f},{"./Item/apis":176,"./Item/createExpirationDate":179,"./Item/encoder":180,"ac-checksum":158,"ac-object":164}],176:[function(d,g,b){var h=d("ac-console").log;
...
return true}});return i}};g.exports=f},{"./apis/localStorage":177,"./apis/userData":178,"ac-console":8}],177:[function(d,f,b){var a=d("ac-feature");
...
return true}};f.exports=c},{"ac-feature":160}],178:[function(d,f,c){var g=d("ac-dom-nodes");
...
}return this._element}};f.exports=b},{"ac-dom-nodes":22}],179:[function(b,c,a){var f=1000*60*60*24;
...
}g.setTime(g.getTime()+(h*f));return g.getTime()};c.exports=d},{}],180:[function(b,c,a){var f=b("./encoder/compressor");
...
}return false}catch(h){return false}}};c.exports=d},{"./encoder/compressor":181}],181:[function(b,c,a){var g=1000*60*60*24;
...
},offsetDaysToMilliseconds:function(h){return(h+d)*g}};c.exports=f},{}],182:[function(g,h,d){var c=g("ac-object");
...
},setOptions:function(j){this._namespace=j}};h.exports=i},{"./Item/apis/localStorage":177,"./Storage/registry":183,"ac-object":164}],183:[function(f,g,c){var d=f("../Item");
...
}};g.exports=a},{"../Item":175}],184:[function(c,f,a){var d=c("../Item/apis");var g;
f.exports=function b(){if(g!==undefined){return g}g=!!d.best();return g}},{"../Item/apis":176}],"++O3BW":[function(b,c,a){c.exports={observer:{Audio:b("./ac-analytics/observer/Audio"),Click:b("./ac-analytics/observer/Click"),Event:b("./ac-analytics/observer/Event"),Exit:b("./ac-analytics/observer/Exit"),Gallery:b("./ac-analytics/observer/Gallery"),Link:b("./ac-analytics/observer/Link"),Overlay:b("./ac-analytics/observer/Overlay"),Page:b("./ac-analytics/observer/Page"),Section:b("./ac-analytics/observer/Section"),Video:b("./ac-analytics/observer/Video")},regions:b("./ac-analytics/regions/regions")}
},{"./ac-analytics/observer/Audio":194,"./ac-analytics/observer/Click":195,"./ac-analytics/observer/Event":196,"./ac-analytics/observer/Exit":197,"./ac-analytics/observer/Gallery":198,"./ac-analytics/observer/Link":199,"./ac-analytics/observer/Overlay":200,"./ac-analytics/observer/Page":201,"./ac-analytics/observer/Section":202,"./ac-analytics/observer/Video":203,"./ac-analytics/regions/regions":226}],"ac-analytics":[function(b,c,a){c.exports=b("++O3BW")
},{}],187:[function(b,a,d){var f;var i=b("ac-array");var g=b("./error-handler/ErrorHandler");
var h=b("ac-storage");var j="analytics-queue";function c(){this._storage=h;this._arr=[];
...
};a.exports=c},{"./error-handler/ErrorHandler":191,"ac-array":1,"ac-storage":174}],188:[function(c,b,g){var h;
...
this._plugin.submit(m);this._queue.remove()};h.pause=function(){if(this.paused===true){return
...
}if(j.exception){return}n();m.resolve();return m.promise()};b.exports=i},{"./Queue":187,"./error-handler/ErrorHandler":191,"./plugins/plugins":204,"./translator/translator":237,"ac-deferred":12}],189:[function(c,b,d){var g;
...
}this.element=k;this.eventCallback=l;this.addEventListener()}g=i.prototype;g.addEventListener=function(){j.addEventListener(this.element,"touchstart",this._onTouchStart.bind(this))
};g._onTouchStart=function(k){this.moved=false;this._boundOnTouchMove=this._onTouchMove.bind(this);
this._boundOnTouchEnd=this._onTouchEnd.bind(this);j.addEventListener(this.element,"touchmove",this._boundOnTouchMove);
j.addEventListener(this.element,"touchend",this._boundOnTouchEnd)};g._onTouchMove=function(k){this.moved=true
};g._onTouchEnd=function(k){j.removeEventListener(this.element,"touchmove",this._boundOnTouchMove);
j.removeEventListener(this.element,"touchend",this._boundOnTouchEnd);if(!this.moved){this.eventCallback(k)
}};b.exports=i},{"../error-handler/ErrorHandler":191,"ac-dom-events":13,"ac-dom-nodes":22}],190:[function(b,c,a){(function(){function d(h){var f;
var g={};var i;if(h&&h.length>0){f=h.split(",");if(f&&f.length>0){f.forEach(function(j){i=j.split(":");
g[i[0]]=i[1]})}}return g}c.exports={dataStringToObject:d}}())},{}],191:[function(d,f,c){var g;
...
j=(m||"")+i+(l||"")+o}return h+o+j+n};f.exports=new b()},{"ac-console":8}],192:[function(b,c,a){(function(){var k=b("ac-array");
var m=b("./error-handler/ErrorHandler");var j=document.getElementsByTagName("head")[0];
var l=k.toArray(j.getElementsByTagName("meta"));var t="analytics";var n="^"+t+"-";
var u=new RegExp(n);var v;var w=Date.now();var r="metadata";function q(y){var x=o(y.track);
if(!Array.isArray(x)||x.length===0){m.log(r,"_getProductname",'"track" meta tag value is malformed. e.g. "product name - page name"')
}if(m.exception){return}return x[0].trim()}function h(x){if(!x.track||x.track===""){m.log(r,"_getPageName",'"track" meta tag value is malformed. e.g. "product name - page name"')
}if(m.exception){return}return x.track.toLowerCase()}function f(){var x=document.documentElement.lang;
...
}if(m.exception){return}return y.split(x)}v=d(l);c.exports=i(v)}())},{"./error-handler/ErrorHandler":191,"ac-array":1}],193:[function(b,d,a){var c=b("./Tracker");
d.exports=new c("sCode");d.exports.Tracker=c},{"./Tracker":188}],194:[function(c,b,g){var h;
...
};b.exports=j},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-dom-events":13,"ac-object":118}],195:[function(f,c,j){var l;
...
var n=f("../controller/Touch");var g={dataAttribute:"analytics-click"};var b="ClickAnalyticsObserver";
function d(q){if(m.exception){return}this.options=h.defaults(g,q||{});this.tracker=o;
this.addListener()}l=d.prototype;l.addListener=function(){var q=a.querySelectorAll("*[data-"+this.options.dataAttribute+"]");
q.forEach(function(r){if(!i.touchAvailable()){p.addEventListener(r,"mouseup",this._onMouseUp.bind(this))
}else{new n(r,this._onTouchStart.bind(this))}}.bind(this))};l._onTouchStart=function(q){var r=p.target(q);
this._track(q,r)};l._onMouseUp=function(q){var r=(q.currentTarget)?q.currentTarget:q.srcElement;
this._track(q,r)};l._track=function(t,u){var q={};var r;if(!u.getAttribute("data-"+this.options.dataAttribute)){r=a.ancestor(u,"[data-"+this.options.dataAttribute+"]");
if(k.isElement(r)){u=r}}if(!k.isElement(u)){m.log(b,"_track",u+" is not a valid DOM element")
}if(m.exception){return}q.targetEl=u;this.tracker.track({type:"click",event:t,data:q,options:this.options})
};c.exports=d},{"../controller/Touch":189,"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-dom-events":13,"ac-dom-nodes":22,"ac-dom-traversal":44,"ac-feature":114,"ac-object":118}],196:[function(c,b,g){var h;
...
};b.exports=j},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-object":118}],197:[function(b,a,f){var g;
...
this.tracker=j;this.addExitListener()}g=i.prototype;g.addExitListener=function(){if("onbeforeunload" in window){k.addEventListener(window,"beforeunload",this._onBeforeUnload.bind(this))
...
};a.exports=i},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-dom-events":13,"ac-object":118}],198:[function(c,b,g){var h;
var f=c("ac-object");var l=c("../metricsTracker");var j=c("../metadata");var i=c("../error-handler/ErrorHandler");
var d={trackAutoRotate:false};var a="GalleryAnalyticsObserver";function k(m,n){if(!m||typeof m!=="object"){i.log(a,null,m+" is not an object")
...
this.gallery.on("didShow",this._track,this)};h.removeListener=function(){this.gallery.off("willShow",this._onWillShow);
this.gallery.off("didShow",this._track)};h._onWillShow=function(n){var m;this.interactionEvent=null;
...
b.exports=k},{"../error-handler/ErrorHandler":191,"../metadata":192,"../metricsTracker":193,"ac-object":118}],199:[function(c,b,h){var a=c("ac-dom-traversal");
var g=c("ac-object");var l=c("ac-dom-events");var k=c("../metricsTracker");var j=c("../error-handler/ErrorHandler");
var i;var f={dataAttribute:"analytics-click",silent:true};function d(m){if(j.exception){return
}this.options=g.defaults(f,m||{});this.tracker=k;this.defaultTracking=this._track.bind(this);
this.addListener()}i=d.prototype;i.addListener=function(){l.addEventListener(document.body,"mouseup",this.defaultTracking)
};i.removeListener=function(){l.removeEventListener(document.body,"mouseup",this.defaultTracking)
};i._track=function(p){var o={};var q;var m;var n=l.target(p);if(n.nodeName.toLowerCase()==="a"&&!n.getAttribute("data-"+this.options.dataAttribute)){q=n
}if(!q){m=a.ancestor(n,"a");if(m&&!m.getAttribute("data-"+this.options.dataAttribute)){q=m
}}if(q){o.targetEl=q;this.tracker.track({type:"link",event:p,data:o,options:this.options})
}};b.exports=d},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-dom-events":13,"ac-dom-traversal":44,"ac-object":118}],200:[function(c,b,g){var h;
...
};b.exports=j},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-object":118}],201:[function(c,b,g){var h;
var d=c("ac-object");var j=c("../metricsTracker");var i=c("../error-handler/ErrorHandler");
var f={};function a(k){if(i.exception){return}this.options=d.defaults(f,k||{});
this.tracker=j;this.data=this.options.data||{};this._track()}h=a.prototype;h._track=function(l){var k=this.options.data||{};
this.tracker.track({type:"page",event:l,data:k,options:this.options})};b.exports=a
},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-object":118}],202:[function(d,c,h){var i;
...
var f={dataAttribute:"analytics-section-engagement"};var m={stopOnEngaged:false,timeToEngage:1000};
function k(o){if(j.exception){return}this.options=g.defaults(f,o||{});this.tracker=n;
this.elementEngagement=new b();this._loadSections()}i=k.prototype;i._loadSections=function(){this.sections=a.querySelectorAll("[data-"+this.options.dataAttribute+"]");
this.sections.forEach(function(q){var o;var p=q.getAttribute("data-"+this.options.dataAttribute);
o=l.dataStringToObject(p);o=this._castDataAttributeOptions(o);o=g.defaults(m,o);
this.elementEngagement.addElement(q,o)},this);if(this.sections&&this.sections.length>0){this._setPosition();
this.options.elements=this.sections;this._bindEvents();this.elementEngagement.start()
}};i._setPosition=function(){var p;var o=this.sections.length;for(p=0;p<o;p+=1){this.sections[p].position=p+1
}};i._castDataAttributeOptions=function(p){var o;var r;var q;p=g.clone(p);Object.keys(p).forEach(function(t){var u=p[t];
var v;if(u==="false"){v=false}else{if(u==="true"){v=true}else{if(!isNaN(parseFloat(u))){v=parseFloat(u)
}else{v=u}}}p[t]=v});return p};i._bindEvents=function(){this.elementEngagement.on("thresholdexit",this._onThresholdExit,this);
this.elementEngagement.windowDelegate.on("scroll",this._onScroll,this)};i._onThresholdExit=function(o){if(o.engaged){var p={element:o};
this.elementEngagement.stop(o);this._track(p)}};i._onScroll=function(){var o=this.elementEngagement.windowDelegate;
if(o.scrollY()>=o.maxScrollY()){this._pageEnd()}};i._pageEnd=function(){var o=this.elementEngagement.elements.length;
var p=[];this.elementEngagement.elements.forEach(function(q){if(q.inView&&q.inThreshold&&q.tracking){p.push(q)
}});p.forEach(function(q){if(q.engaged){this._forceTracking(q)}else{if(q.has("engaged")===false){q.once("engaged",this._forceTracking,this)
}}},this)};i._forceTracking=function(o){o.thresholdExitTime=Date.now();this.elementEngagement.stop(o);
this._track({element:o})};i._track=function(o){this.tracker.track({type:"section",data:o,options:this.options})
};c.exports=k},{"../data-attr/helper":190,"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-dom-traversal":44,"ac-element-engagement":110,"ac-object":118}],203:[function(c,b,g){var h;
var d=c("ac-object");var i=c("../error-handler/ErrorHandler");var k=c("../metricsTracker");
var f={mediaEvents:[],mediaEventCallbacks:{},mediaEventPrefix:"acv-"};var a="VideoAnalyticsObserver";
var j="data-analytics-id";function l(n,m){var o;if(!n||typeof n!=="object"){i.log(a,null,n+" is not an object")
}this.options=d.defaults(f,m||{});if(!Array.isArray(this.options.mediaEvents)){i.log(a,null,this.options.mediaEvents+" is not a valid media events array")
}if(i.exception){return}this.tracker=k;this.video=n;this.playCount=0;this.captionsEnableCount=0;
this._callbacks={};o=this.options.mediaEventPrefix;this._events={play:o+"play",ended:o+"ended",timeupdate:o+"timeupdate",scrubStart:o+"scrub-start",scrubEnd:o+"scrub-end",captionsEnabled:o+"captions-enabled"};
this.attachEvents()}h=l.prototype;h.attachEvents=function(){var m=this.options;
var n;m.mediaEvents.forEach(function(o){n=m.mediaEventCallbacks[o];n=(typeof n==="function")?n:this._defaultTracking.bind(this,o);
this._callbacks[o]=n;this.addListener(m.mediaEventPrefix+o,this._callbacks[o])}.bind(this));
...
this.video.on(this._events.timeupdate,this._onTimeupdate,this)};h.detachEvents=function(){var m=this.options;
m.mediaEvents.forEach(function(n){this.removeListener(m.mediaEventPrefix+n,this._callbacks[n])
}.bind(this))};h._onPlay=function(n){var m=this._bundleTrackingData("play",n);m.playCount=this.playCount;
this.track(m);this.playCount+=1;this._playBound=false};h._onTimeupdate=function(m){if(m.currentTime===0){if(this.playCount>0){this._bindPlay()
}}};h._bindPlay=function(){if(!this._playBound){this.video.once(this._events.play,this._onPlay,this);
this._playBound=true}};h._onCaptionsEnabled=function(n){var m=this._bundleTrackingData("captions-enabled",n);
m.captionsEnableCount=this.captionsEnableCount;this.track(m);this.captionsEnableCount+=1
};h._onEnded=function(n){var m=this._bundleTrackingData("ended",n);this.ended=true;
this.track(m);this._bindPlay()};h.addListener=function(m,n){this.video.on(m,n)};
h.removeListener=function(m,n){this.video.off(m,n)};h._getCommonVideoData=function(){var m={};
m.targetEl=this.video.element;m.videoId=(m.targetEl.hasAttribute(j))?m.targetEl.getAttribute(j):this.video.targetId;
m.ended=this.ended;return m};h._bundleTrackingData=function(n,o){var m=this._getCommonVideoData();
m.eventType=n;return d.extend(d.clone(o),m)};h._defaultTracking=function(m,o){var n=this._bundleTrackingData(m,o);
this.track(n)};h.track=function(m){this.tracker.track({type:"video",data:m,options:this.options})
};b.exports=l},{"../error-handler/ErrorHandler":191,"../metricsTracker":193,"ac-object":118}],204:[function(b,c,a){c.exports={sCode:b("./s-code/sCode")}
},{"./s-code/sCode":209}],205:[function(b,c,a){(function(){var f=b("ac-dom-nodes");
function d(h){var i=true;if(f.isElement(h)&&h.href){var g=h.getAttribute("href");
if(g.charAt(0)!=="#"&&g.indexOf("javascript:")===-1){i=false}}return i}c.exports={isIntraPageLink:d}
}())},{"ac-dom-nodes":22}],206:[function(b,c,a){(function(){var l=b("../../../error-handler/ErrorHandler");
var f="sCodePluginFormatter";function r(u){return g(u)}function m(x,u){var w="www.";
var v={"fr-ca":"ca.fr"};w+=v[u]?v[u]:k(u);return w+"."+x}function p(w,u){var x="";
var v={"fr-ca":"ca-fr"};var y=v[u];w=w||"";if(typeof u==="string"){u=u.toLowerCase();
x=y?v[u]:k(u);x=q(x)}return g(w)+x}function o(u,v){u=u||"";v=v||"";return !!u?(u+"@"+v):v
}function t(v){var x;var u={"fr-ca":"ca/fr","en-419":"lae","en-ap":"asia"};var w=["fr-be","nl-be","fr-ch","de-ch"];
if(u[v]){x=u[v]}else{if(w.indexOf(v)>=0){x=v.split("-").reverse().join("-")}else{x=j(v)
}}return x}function k(v){var u;var w={"fr-be":"bf","nl-be":"bl","fr-ch":"cr","de-ch":"ce","en-419":"la","en-gb":"uk"};
if(w[v]){u=w[v]}else{u=j(v)}return u}function d(w){var v={};if(typeof(w)==="object"){for(var u in w){v[u]=i(w[u])
}}return v}function n(x,w,u){var v=x;w=(typeof w==="string")?w:"";u=(typeof u==="string")?u:"";
if(typeof v==="string"){v=v.replace(new RegExp(w,"g"),u)}return v}function j(u){if(!u){l.log(f,"_getCountryCodeFromLocale","locale should be a valid string")
}if(l.exception){return}var v=u.split("-");var w;if(v.length>1){w=g(v[1])}return w
}function q(u){if(!u){l.log(f,"_decorateCountryCode","countryCode should be a valid string")
}if(l.exception){return}return" ("+g(u)+")"}var h=/[\ì\î\ë\í]/g;function i(u){if(typeof u==="string"){u=u.replace(h,"")
}return u}function g(u){if(typeof u==="string"){u=u.toLowerCase()}return u}c.exports={productName:r,channel:m,pageName:p,eventString:o,countryCodeFilter:t,legacyCountryCode:k,cleanProps:d,stringReplacer:n,lowerCaseString:g}
}())},{"../../../error-handler/ErrorHandler":191}],207:[function(b,c,a){(function(){var k=b("../../../error-handler/ErrorHandler");
...
}())},{"../../../error-handler/ErrorHandler":191,"./../../../metadata":192}],208:[function(b,c,a){(function(){var d=b("./formatter");
function g(h,i){return[{name:"{PAGE_NAME}",value:h.pageName},{name:"{PAGE_NAME_NO_LOCALE}",value:i.pageName},{name:"{CHANNEL}",value:h.channel},{name:"{CAMPAIGN}",value:h.campaign},{name:"{COUNTRY_CODE}",value:h.legacyCountryCode},{name:"{COUNTRY_CODE_FILTER}",value:h.countryCodeFilter},{name:"{PRODUCT_NAME}",value:h.productName},{name:"{PLATFORM}",value:h.platform}]
}function f(i,h){if(typeof i==="string"){h.forEach(function(j){if(i.indexOf(j.name)>-1){i=d.stringReplacer(i,j.name,j.value)
}})}return i}c.exports={set:g,translate:f}}())},{"./formatter":206}],209:[function(f,c,h){var l;
...
this.setFormattedValues();this.setTemplateVars();this.initializeSCode()}l=k.prototype;
l.initializeSCode=function(){var r={bucket:this.getBucket(),channel:this.formattedValues.channel,pageName:this.formattedValues.pageName,linkInternalFilters:this.getLinkInternalFilters()};
p.init(r)};l.setPageMetadata=function(r){this.pageMetadata=g.clone(r);this.pageMetadata.platform=o.platform();
this.pageMetadata.channel=o.channel();this.pageMetadata.campaign=o.campaign();this.pageMetadata.pageName=q.lowerCaseString(this.pageMetadata.pageName);
...
};l.clearProps=function(){var r=p.getInstance();if(typeof r==="object"){r.prop4=r.g_prop4=r.prop6=r.g_prop6=r.pageURL=r.g_pageURL=r.g_channel=""
...
}if(t!=="title"){v.data.linkTrackVars.push(t);r[t]=u[t]}}};l.getBucket=function(){var w=i.length;
var r=2;for(var u=0;u<w;u++){if(i[u].indexOf(this.formattedValues.legacyCountryCode)!==-1){r=u;
break}}var t=o.bucket(r);var x=this._replaceTemplateVars(t);var v=this._replaceTemplateVars(o.bucketProduct(r));
return x+(!!v?(","+v):"")};l._replaceTemplateVars=function(r){return j.translate(r,this.templateVarArr)
};c.exports=k},{"../../error-handler/ErrorHandler":191,"../../metadata":192,"./helpers/formatter":206,"./helpers/metadata":207,"./helpers/templateVar":208,"./submit-methods/submitMethods":211,"./translator/translator":224,"ac-object":118,"ac-s-code":143}],210:[function(b,c,a){(function(){function f(l,j,h){var i=window.location.href;
...
}c.exports=f}())},{}],211:[function(c,g,b){var f=c("./t");var a=c("./tl");var d=c("./manual");
g.exports={t:f,tl:a,manual:d}},{"./manual":210,"./t":212,"./tl":213}],212:[function(b,c,a){(function(){function d(h,g,f){if(typeof f==="object"&&typeof f.t==="function"){f.pageName=g.pageName;
f.channel=g.channel;f.t()}}c.exports=d}())},{}],213:[function(b,c,a){(function(){var f=b("../../../error-handler/ErrorHandler");
...
var n=d.isIntraPageLink(m);if(!m||n===true){o=false}return o}c.exports=i}())},{"../../../error-handler/ErrorHandler":191,"../helpers/DOM":205}],214:[function(b,c,a){(function(){var d=b("../../helpers/formatter");
...
}())},{"../../helpers/formatter":206}],215:[function(b,c,a){(function(){var h=b("ac-storage");
var d=b("../../../../data-attr/helper");var g=b("../../helpers/formatter");var f=b("../../helpers/DOM");
function i(m,u,l){var k=m;var o=k.data;var n=" - ";var q={};var p=o.targetEl.getAttribute("data-"+m.options.dataAttribute);
...
if(o.region){h.setItem("s_nav",o.region)}k.properties=q;k.submitMethod="tl";return k
}c.exports={translate:i}}())},{"../../../../data-attr/helper":190,"../../helpers/DOM":205,"../../helpers/formatter":206,"ac-storage":174}],216:[function(b,c,a){(function(){var d=b("../../helpers/formatter");
...
}}i.properties=k;i.submitMethod="tl";return i}c.exports={translate:g}}())},{"../../helpers/formatter":206,"../../helpers/templateVar":208}],217:[function(b,c,a){(function(){var d=b("../../helpers/formatter");
...
return g}c.exports={translate:f}}())},{"../../helpers/formatter":206}],218:[function(b,c,a){(function(){var d=b("../../../../error-handler/ErrorHandler");
...
}c.exports={translate:i}}())},{"../../../../error-handler/ErrorHandler":191,"../../helpers/formatter":206}],219:[function(b,c,a){(function(){var g=b("ac-storage");
var f=b("../../helpers/formatter");var d=b("../../helpers/DOM");function h(k,r,j){var i=k;
var m=i.data;var l=" - ";var n=(m.targetEl.href)?m.targetEl.getAttribute("href"):"";
...
i.options.async=(!p)?false:true;if(m.region){g.setItem("s_nav",m.region)}i.properties=o;
i.submitMethod="tl";return i}c.exports={translate:h}}())},{"../../helpers/DOM":205,"../../helpers/formatter":206,"ac-storage":174}],220:[function(b,c,a){(function(){var d=b("../../helpers/formatter");
function f(j,i,k){var g=j;var h={};g.properties=h;g.submitMethod="tl";return g}c.exports={translate:f}
}())},{"../../helpers/formatter":206}],221:[function(b,c,a){(function(){var f=b("ac-storage");
var d=b("../../helpers/formatter");var g=b("../../helpers/templateVar");function h(l,q,k){var j=l;
var m=j.data;var o=g.set(q,k);var p={};var t=i();var n=f.getItem("s_nav");for(var r in m){p[r]=m[r];
if(typeof p[r]==="string"){p[r]=g.translate(p[r],o)}}if(t){p.prop25=t}if(n){f.removeItem("s_nav");
p.prop25=n}if(!p.prop25){p.prop25="other nav or none"}j.properties=p;j.submitMethod="t";
return j}function i(){var j=document.referrer;var k=window.location.host;var l;
if(!j){l="direct entry"}if(j&&j!==""&&j.split("?")[0].indexOf(k)===-1){l="third party"
}return l}c.exports={translate:h}}())},{"../../helpers/formatter":206,"../../helpers/templateVar":208,"ac-storage":174}],222:[function(b,c,a){(function(){function d(i,l,h){var f=i;
...
}())},{}],223:[function(b,c,a){(function(){var d=b("../../helpers/formatter");function g(k,p,j){var i=k;
...
}c.exports={translate:g}}())},{"../../helpers/formatter":206}],224:[function(b,c,a){(function(){var d={audio:b("./component/audio"),gallery:b("./component/gallery"),link:b("./component/link"),click:b("./component/click"),overlay:b("./component/overlay"),page:b("./component/page"),section:b("./component/section"),video:b("./component/video"),exit:b("./component/exit"),event:b("./component/event")};
function f(i,g,j){var h=i;if(i.type&&d[i.type]){h=d[i.type].translate(i,g,j)}return h
}c.exports={translate:f,components:d}}())},{"./component/audio":214,"./component/click":215,"./component/event":216,"./component/exit":217,"./component/gallery":218,"./component/link":219,"./component/overlay":220,"./component/page":221,"./component/section":222,"./component/video":223}],225:[function(b,a,c){var d;
...
},{"../data-attr/helper":190}],226:[function(b,c,a){(function(){var d=b("ac-dom-traversal");
...
}())},{"./Region":225,"ac-dom-nodes":22,"ac-dom-traversal":44}],227:[function(b,c,a){(function(){var f=b("ac-dom-traversal");
...
return i}c.exports={translate:g}}())},{"ac-dom-events":13,"ac-dom-traversal":44}],228:[function(b,c,a){(function(){var d=b("ac-dom-traversal");
...
},{"../../regions/regions":226,"ac-dom-traversal":44}],229:[function(b,c,a){(function(){function d(g){var f=g;
return f}c.exports={translate:d}}())},{}],230:[function(b,c,a){(function(){function d(g){var f=g;
return f}c.exports={translate:d}}())},{}],231:[function(b,c,a){(function(){var d=b("ac-dom-traversal");
...
}return n}c.exports={translate:g}}())},{"ac-dom-traversal":44}],232:[function(b,c,a){(function(){var d=b("ac-dom-traversal");
var g=b("../../regions/regions");function f(l){var j=l;var h=d.querySelector("img",l.data.targetEl);
...
}())},{"../../regions/regions":226,"ac-dom-traversal":44}],233:[function(b,c,a){(function(){function d(g){var f=g;
return f}c.exports={translate:d}}())},{}],234:[function(b,c,a){(function(){function d(g){var f=g;
return f}c.exports={translate:d}}())},{}],235:[function(b,c,a){(function(){function d(f){return f
}c.exports={translate:d}}())},{}],236:[function(b,c,a){(function(){var d={play:function(h){if(h.data.ended===true){return"replay"
...
}return h}c.exports={translate:f}}())},{}],237:[function(b,c,a){(function(){var d=b("../error-handler/ErrorHandler");
...
}())},{"../error-handler/ErrorHandler":191,"./component/audio":227,"./component/click":228,"./component/event":229,"./component/exit":230,"./component/gallery":231,"./component/link":232,"./component/overlay":233,"./component/page":234,"./component/section":235,"./component/video":236}]},{},["++O3BW"]);